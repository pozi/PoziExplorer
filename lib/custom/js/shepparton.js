...
var busStopsShow = function(a){
	showOrHideLayer("Bus Stops",true);
	showOrHideLayer("Bus Routes",true);
}

var busStopsHide = function(){
	// Removing the selected feature
	vector_layer.removeAllFeatures();
	showOrHideLayer("Bus Stops",false);
	showOrHideLayer("Bus Routes",false);
}

// Parameter is the subtab being activated
var showWalkingRouteTo = function(b){
